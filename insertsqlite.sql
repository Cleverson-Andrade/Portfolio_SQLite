-- =============================================================================
-- Arquivo: insertsqlite.sql | File: insertsqlite.sql
-- Este script contém os comandos para inserir dados nas tabelas de um mini-projeto em SQLite.
-- This script contains commands to insert data into tables for a mini-project in SQLite.
-- =============================================================================
...
-- IMPORTANT NOTE: Ensure that the tables have already been created by running the 'schema.sql' script before running this script.

-- Inserindo dados na tabela 'tipos_produtos' | Inserting data into 'tipos_produtos' table
...
-- Inserindo dados na tabela 'produtos' | Inserting data into 'produtos' table
...
-- Inserindo dados na tabela 'pacientes' | Inserting data into 'pacientes' table
...
-- Inserindo dados na tabela 'professor' | Inserting data into 'professor' table
...
-- Inserindo dados na tabela 'turma' | Inserting data into 'turma' table
...
-- Inserindo dados na tabela 'escritorios' | Inserting data into 'escritorios' table
...
-- Inserindo dados na tabela 'funcionarios' | Inserting data into 'funcionarios' table
...
-- Inserindo dados na tabela 'pagamentos' | Inserting data into 'pagamentos' table
...
-- Inserindo dados na tabela 'categorias' | Inserting data into 'categorias' table
...
-- Inserindo dados na tabela 'produtos_agregacao' | Inserting data into 'produtos_agregacao' table
...
-- Inserindo dados na tabela 'tipos_agrupamento' | Inserting data into 'tipos_agrupamento' table
...
-- Inserindo dados na tabela 'fabricantes' | Inserting data into 'fabricantes' table
...
-- Inserindo dados na tabela 'produtos_agrupamento' | Inserting data into 'produtos_agrupamento' table
...
-- Inserindo dados na tabela 'profissoes' | Inserting data into 'profissoes' table
...
-- Inserindo dados na tabela 'clientes_juncao' | Inserting data into 'clientes_juncao' table
...
-- Inserindo dados na tabela 'consumidor' | Inserting data into 'consumidor' table
